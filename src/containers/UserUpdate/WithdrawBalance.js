...
class WithdrawBalance extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <TextField
          floatingLabelText='Withdraw amount (in Ether)'
          hintText='Input the amount you wish to withdraw in Ether.'
          type='number'
          value={amount}
        ...
        <RaisedButton
          ...
          fullWidth={true}
          disabled={false}
          onClick={this.submitWithdrawAmount}/>
      </div>
    )
  }
}

WithdrawBalance.contextTypes = {
...
export default connect(mapStateToProps)(WithdrawBalance)
